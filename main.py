...
UUID = os.environ.get('UUID', '2a2f6fa3-c2c6-4484-885c-10628766c5d6')  # UUID for cross-platform v1 nezha
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'guding.rg520.dpdns.org')          # Argo fixed tunnel domain, leave empty for temporary tunnel
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiNzdiNzY1YmViZjhlMGRiZDAwZjg0MjRiOTM4NWI0ZGUiLCJ0IjoiMWYwOWU2MjYtNzE5YS00YzBmLThmYjQtZDNmZWVhYTBiNGI1IiwicyI6Ik9EZGpNVFk0WkdNdFltTTVZUzAwWkdSaExUa3dPV1l0TURoaFpXVXhNVFZoWldWbSJ9')              # Argo fixed tunnel token or json, leave empty for temporary tunnel
